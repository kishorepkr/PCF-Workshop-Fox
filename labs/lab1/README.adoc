...
====
----
Using manifest file /Users/phopper/workspace/Workshop-101/cf-spring-mvc-boot/manifest.yml <1>
...
Uploading app files from: /Users/phopper/workspace/PCF-Workshop-101/cf-spring-mvc-boot/target/cf-spring-mvc-boot-0.0.1-SNAPSHOT.jar
